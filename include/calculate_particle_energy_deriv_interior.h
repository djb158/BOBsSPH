...
#ifndef BOBSSPH_CALCULATE_PARTICLE_ENERGY_DERIVATIVE_INTERIOR_H
#define BOBSSPH_CALCULATE_PARTICLE_ENERGY_DERIVATIVE_INTERIOR_H
...
void *CalculateParticleEnergyDeriv_INTERIOR(void *edtd);
