...
#ifndef BOBSSPH_SET_INITIAL_PARTICLE_STATE_1D_H
#define BOBSSPH_SET_INITIAL_PARTICLE_STATE_1D_H
...
extern IDS *SetParticleID_1D(PARS *pars, PARTICLES *particles, double x, double y, double z);

PARTICLES *SetInitialParticlesState1D(PARS *pars,int particles_num,char *rank_name);

#endif /* BOBSSPH_SET_INITIAL_PARTICLE_STATE_1D_H */
